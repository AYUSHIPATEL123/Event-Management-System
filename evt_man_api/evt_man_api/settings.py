"""
Django settings for evt_man_api project.
...
SECRET_KEY = 'django-insecure-de7h(zw+0=daqwd^qsftws(x_tbw60mb$o(!0=5$3th@#&byc4'
...
WSGI_APPLICATION = 'evt_man_api.wsgi.application'
...
USE_TZ = True
AUTH_USER_MODEL = 'event_manager.UserProfile'
